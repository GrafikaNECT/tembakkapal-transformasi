bin/main: Makefile src/mgame.cpp src/game.cpp src/drawable.cpp src/kapalterbang.cpp src/kapallaut.cpp src/bullet.cpp src/line-pattern.c src/bresenham.c src/print.c src/game.h src/drawable.h src/kapalterbang.h src/kapallaut.h src/bullet.h src/line-pattern.h src/bresenham.h src/print.h src/drawBitPicture-old.h src/drawBitPicture-old.cpp src/alphabet.h src/alphabet.cpp src/pixelBoolMatrix.h src/pixelBoolMatrix.cpp src/letter.h src/letter.cpp src/polygon.h src/polygon.cpp src/alphabet-2.txt bin src/point.cpp src/point.h
	g++ src/mgame.cpp src/game.cpp src/drawable.cpp src/kapalterbang.cpp src/kapallaut.cpp src/bullet.cpp src/line-pattern.c src/bresenham.c src/print.c src/drawBitPicture-old.cpp src/alphabet.cpp src/pixelBoolMatrix.cpp src/letter.cpp src/polygon.h src/polygon.cpp src/point.cpp -o bin/main -fpermissive -std=c++11 -w -g
