...
void game::init(){
	...
	initTermios();
	initializePrinter();
	kapalterbang newkapal(getXRes(),200,40,18);
	...
	kapalterbang newkapal2(getXRes(),200,40,18,"planecolor2.txt");
	...
	kapalterbang newkapal3(getXRes(),200,40,18,"planecolor3.txt");
