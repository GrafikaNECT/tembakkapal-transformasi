...
public:
	...
	void drawCircle(unsigned int _R, unsigned int _G, unsigned int _B, unsigned int _alpha, bool half);
...
private:
	...
	void plot4points(int x, int y, bool half);
	void plot8points(int x, int y, bool half);
};
