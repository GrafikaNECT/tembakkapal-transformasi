...
int main(){
	...
	for (i=400;i>0;i--){
		...
		printText("Candy Olivia M",14,150,i-50,i%200,i%150,i%255,255);
		printText("Erick Chandra",13,150,i-75,i%200,i%150,i%255,255);
		printText("M Nizami",9,150,i-100,i%200,i%150,i%255,255);
		usleep(5000);
		printText("GRAPHICAT!!!",12,150,i,255,255,255,255);
		printText("Asanilta Fahda",14,150,i-25,255,255,255,255);
		printText("Candy Olivia M",14,150,i-50,255,255,255,255);
		printText("Erick Chandra",13,150,i-75,255,255,255,255);
